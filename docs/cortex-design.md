...
| **Brainstem** | Validation, classification, routing LLM | <REDACTED_LAN_IP> | RTX 4070 Super | 12 GB | TBD |
...
`BRAINSTEM_LLM_URL=http://<REDACTED_LAN_IP>:8000`
