param([string]$WorkflowId = "<REDACTED_WORKFLOW_ID>", [int]$Limit = 3)
...
$execs = Invoke-RestMethod -Uri "https://<REDACTED_N8N_HOST>/api/v1/executions?workflowId=$WorkflowId&limit=$Limit&includeData=true" -Headers $headers
